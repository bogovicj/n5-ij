...
public class N5ImagePlusMetadata implements N5Metadata< ImagePlus >
{
	...
	protected static final String imagePropertiesKey = "imageProperties";
	...
	public void readMetadata( N5Reader n5, String dataset, ImagePlus imp ) throws IOException
	{
		...
		Properties readProperties = n5.getAttribute( dataset, imagePropertiesKey, Properties.class );
		for( Object k : readProperties.keySet() )
		{
			properties.put( k, readProperties.get( k ));
		}
